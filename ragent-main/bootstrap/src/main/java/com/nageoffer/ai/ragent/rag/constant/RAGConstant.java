...
public class RAGConstant {
    ...
    /**
     * Deep Research：宏观问题拆解为子问题
     */
    public static final String DEEP_RESEARCH_DECOMPOSE_PROMPT_PATH = "prompt/deep-research-decompose.st";

    /**
     * Deep Research：单个子问题检索结果摘要（独立会话）
     */
    public static final String DEEP_RESEARCH_SUB_SUMMARY_PROMPT_PATH = "prompt/deep-research-sub-summary.st";

    /**
     * Deep Research：基于子问题笔记撰写深度报告
     */
    public static final String DEEP_RESEARCH_REPORT_PROMPT_PATH = "prompt/deep-research-report.st";
}
