...
public class StreamChatEventHandler implements StreamCallback {
    ...
    /**
     * Deep Research 等非主回复流：推送阶段状态（message.type = deep_research）
     */
    public void sendDeepResearchPhase(String jsonPayload) {
        ...
        sender.sendEvent(SSEEventType.MESSAGE.value(), new MessageDelta("deep_research", jsonPayload));
    }
